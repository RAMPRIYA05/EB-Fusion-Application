    ...
    <header>
            ...
            <nav class="navbar-nav">
               ...
               <nav class="navbar">
				...
				<li>
					<div class="dropdown">
						<a style="buttons-atag.active=color:white;text-decoration:underline;">Connection</a>
						<div class="dropdown-content">
...
<h2>Approved Customer Connection</h2>
...
<tr>
        ...
        <td><%=obj.getState() %></td>
	<td><img class="table-image" src="data:image/jpeg;base64,<%= Base64.getEncoder().encodeToString(obj.getAddressProof()) %>" alt="Address Proof" "><br>
